...
- TypeScript's ecosystem (Next.js for dashboard, OpenAI SDK pointing at Groq's free tier for LLM, Razorpay's own TS SDK) makes the execution and orchestration layer faster to build.
